...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void addMeds(takePillsDb takePills) {

        ContentValues values = new ContentValues();
        values.put(COLUMN_MEDNAME, takePills.getMedName());
        values.put(COLUMN_MEDDOSE, takePills.getDose());
        values.put(COLUMN_MEDSTATUS, takePills.getStatus());
        values.put(COLUMN_MEDDATEEND, takePills.getDateEnd());
